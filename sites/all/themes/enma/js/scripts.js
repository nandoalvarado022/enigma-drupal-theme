(function($){
    ...
    //JS onepage menu
        ...
        if ($('#navbar-collapse > ul').hasClass('local-scroll') == true || $('#navbar-collapse > ul').hasClass('local-scroll-no-offset') == true) {
        ...
        $('#nav-search').append('<i class="fa fa-search search-trigger"></i><i class="fa fa-times search-close"></i>');
    ...
    $('.main-wrapper-mp').on('click',function(e) {
        closeSearch();
    });
    ...
    /* Progress Bars
    -------------------------------------------------------*/
    var $section = $('.progress-solid').appear(function() {
